...
class UtilityParser {
    constructor(input, config = {}, cache, device, platform, variants) {
        var _a;
        this.config = config;
        this.cache = cache;
        this.position = 0;
    ...
    handleMatchVariant(prefix, variants) {
        const variant = variants[prefix];
        if (variant === null || variant === void 0 ? void 0 : variant(prefix)) {
            this.incrementOrder();
        }
        else {
            this.isNull = true;
    ...
    parsePrefixes(prefixes, device, platform, variants) {
        var _a, _b, _c, _d, _e;
