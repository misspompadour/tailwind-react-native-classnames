...
import type { StyleIR, DeviceContext, Platform, MatchVariants } from './types';
...
export default class UtilityParser {
    ...
    private isNegative;
    private context;
    constructor(input: string, config: TwConfig, cache: Cache, device: DeviceContext, platform: Platform, variants: MatchVariants);
    parse(): StyleIR;
    private parseUtility;
    private handlePossibleArbitraryBreakpointPrefix;
    private handleMatchVariant;
    private advance;
    private get rest();
    private peekSlice;
