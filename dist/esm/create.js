...
export function create(customConfig, platform) {
    ...
    function style(...inputs) {
        ...
        for (const utility of utilities) {
            ...
            if (!styleIr) {
                const parser = new UtilityParser(utility, config, cache, device, platform, variants);
    ...
    tailwindFn.prefixMatch = (...prefixes) => {
        ...
        const parser = new UtilityParser(`${joined}:flex`, config, cache, device, platform, variants);
